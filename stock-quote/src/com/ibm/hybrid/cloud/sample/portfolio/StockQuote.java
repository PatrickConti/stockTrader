...
public class StockQuote extends Application {
	...
	// Vijay's KEY
//	private static final String QUANDL_KEY = "YbeNgJwFNyQXuEWXv1ZU";
//	private static final String QUANDL_KEY = "_2VFhkQ446andCSWu2Mi";
	
	private static final String QUANDL_KEY = System.getenv("QUANDL_KEY");
...
//		String uri = "https://api.us.apiconnect.ibmcloud.com/jalcornusibmcom-dev/sb/stocks/"+symbol;
	...
	private static JsonObject invokeREST(String verb, String uri) throws IOException {
		System.out.println("Invoking REST - " + verb + " - to uri: " + uri);
		URL url = new URL(uri);
