...
//	activationConfig = {
//		@ActivationConfigProperty(propertyName = "destination", propertyValue = "NOTIFICATION"),
//		@ActivationConfigProperty(propertyName = "destinationType", propertyValue = "javax.jms.Queue") 
//	})
@MessageDriven(name = "NotificationMDB", mappedName="jms/Notification/Queue")
public class NotificationMDB implements MessageListener {
//	private String url = "https://openwhisk.ng.bluemix.net/api/v1/namespaces/zcloud_prod/actions/cc-z-hack/LoyaltyToSlack?blocking=true";
//	private String id = "b8f3e99e-8740-4afa-bf06-c740ad05ea82";
//	private String pwd = "J9gGMjk9f3KJomFKzDuAtLJmT6dOXsDVO0UnPFU19h09GwYnUrEX80GaN64K2Jqr";
	
	private String url = System.getenv("FUNCTIONS_URL");
	private String apiKey = System.getenv("FUNCTIONS_API_KEY");
...
//			invokeREST("POST", url, json, id, pwd);
			invokeREST("POST", url, json, apiKey);
		} catch (Throwable t) {
			t.printStackTrace();
		} else {
...
//		JSONObject json = JSONObject.parse(stream); //JSON4J
	...
	private static JsonObject invokeREST(String verb, String uri, String input, String apiKey) throws IOException {
		URL url = new URL(uri);
		...
		if ((apiKey != null)) { //send via basic-auth
