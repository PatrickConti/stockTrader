...
public class LoyaltyLevel extends Application {
	private static final String NOTIFICATION_Q   = "jms/NotificationQueue";
	private static final String NOTIFICATION_QCF = "jms/NotificationQueueConnectionFactory";
	...
	public JsonObject getLoyalty(@QueryParam("owner") String owner, @QueryParam("oldLoyalty") String oldLoyalty, @QueryParam("currentLoyalty") String loyalty) {
