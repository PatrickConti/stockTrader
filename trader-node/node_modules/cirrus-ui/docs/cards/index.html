            ...
            <div class="row">
                <div class="col-6">
                    <div class="card" style="background:#fff">
                        <div class="card-container">
                            <div class="card-image" style="background:#eee;"></div>
                            <div class="title-container">
...
&lt;/div&gt;
    ...
    <section class="padtop">
        <div class="content">
            <h3>Grouping</h3>
            <div class="divider"></div>
            <p>Need to display multiple cards at once? Worried about having to resize each card? With Cirrus's grid system, you can specify how many cards will be used in each row and your cards will automatically adjust and fill each cell.</p>
            <div class="row">
                <div class="col-4">
                    <div class="card">
                        <div class="card-container">
            ...
            <p>Find out more about the Cirrus's grid system and how it works with other elements <a href="../layout">here</a>!</p>
        </div>
    </section>

    <section>
        <div class="content">
            <h3>Did somebody say Twitter?</h3>
            <div class="divider"></div>
            <p>Below is an example that shows how you can use cards to create any design you want, include tweet cards from Twitter.</p>
            <div class="row">
                <div class="col-5">
                    <div class="card">
                        <div class="card-container">
...
&lt;/div&gt;</code></pre>
    ...
    <!-- Card Tiles -->
    <section id="card-tiles" class="pad-top">
        <div class="content">
            <h3>Card Tiles</h3>
            <div class="divider"></div>
            ...
            <div class="row">
                <pre><code class="HTML" data-lang="HTML">&lt;div class=&quot;card-tile&quot;&gt;
    &lt;div class=&quot;tile-icon&quot;&gt;
        &lt;figure class=&quot;avatar&quot;&gt;
            &lt;img src=&quot;https://www.seoclerk.com/pics/319222-1IvI0s1421931178.png&quot;&gt;
        &lt;/figure&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <p>In the two examples above, the first one is your standard tile with the <code>card-tile</code> parent container and <code>tile-container</code> for other elements images, text, buttons, etc. The <code>tile-buttons</code> class could be used also to display buttons horizontally. The card tile at the bottom vertically aligns all elements to be vertically centered giving a more balanced appearance.</p>
            <div class="row">
                <div class="col-4">
                    <div class="card-tile tile-center">
                        <div class="tile-icon">
