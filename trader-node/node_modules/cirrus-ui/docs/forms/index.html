...
<body>
    ...
    <section id="started" class="padtop">
        <div class="content">
            ...
            <p>Perhaps one of the most important components on the web, <b>forms</b> allow users to fill in data easily. Cirrus covers the styles of labels,inputs, textareas, selects, with support coming to more controls in the future.</p>
            <p>Here is a sample form below:</p>
             <form>
                    <div class="row">
        ...
        <div class="content" id="input-type-container">
            <h6>Different Types of Forms</h6>
            <div class="row">
                <div class="col-6">
                ...
                <div class="col-6">
                    <pre><code class="html" data-lang="HTML">&lt;div class=&quot;row ignore-screen level&quot;&gt;
    &lt;div class=&quot;col-3 ignore-screen level-item&quot;&gt;&lt;p&gt;Name:&lt;/span&gt;&lt;/div&gt;
    &lt;div class=&quot;col-9 ignore-screen level-item&quot;&gt;&lt;input type=&quot;name&quot; value=&quot;John Doe&quot;&gt;&lt;/div&gt;
&lt;/div&gt;
&lt;div class=&quot;row ignore-screen level&quot;&gt;
...
&lt;/div&gt;</code></pre>
    ...
    <section id="inputfield" class="padtop">
        <div class="content">
            <h3>Input Fields (Textboxes)</h3>
            <div class="divider"></div>
            <p>Input fields in Cirrus are all designed with extra padding, different sizes, and other variations. This section covers input fields for <code>emails, passwords, search, text, tel, and select</code> (dropdown menus). To add margins between adjacent inputs, it is best to wrap them around the <code>input-control</code> class.</p>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <pre><code class="html" data-lang="HTML">&lt;div class=&quot;input-control&quot;&gt;
    &lt;input type=&quot;text&quot; class=&quot;input-xsmall&quot; placeholder=&quot;Extra small (0.65rem)&quot;&gt;
&lt;/div&gt;
&lt;div class=&quot;input-control&quot;&gt;
    &lt;input type=&quot;text&quot; class=&quot;input-small&quot; placeholder=&quot;Small (0.75rem)&quot;&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <space></space>
            <p>The same sizing principle also applies to select controls. Select also uses the classes <code>input-xsmall, input-small, input-large, and input-xlarge</code>.</p>
            <div class="row">
                <div class="input-control">
...
&lt;div class=&quot;row&quot;&gt;
    ...
    &lt;input disabled type=&quot;radio&quot;&gt;   I'm a radio button.&lt;/input&gt;
&lt;/div&gt;
&lt;input disabled type=&quot;submit&quot; class=&quot;animated&quot; /&gt;</code></pre>
            </div>
        </div>
...
&lt;/div&gt;</code></pre>
        ...
        <div class="row">
            <div class="col-6">
                <div class="input-control">
                    <input type="text" class="text-error input-error" placeholder="Success state">
                </div>
                <div class="input-control">
                    <select class="select text-error input-error" placeholder="Dropdown"><option value="1">Error state</option></select>
                </div>
            </div>
            <div class="col-6">
                <pre><code class="html" data-lang="HTML">&lt;div class=&quot;input-control&quot;&gt;
...
&lt;/div&gt;</code></pre>
        ...
        <space class="large"></space>
        <h6>Integrate with Font Awesome</h6>
        <p>Currently a beta feature, this allows you to place Font Awesome glyphs right at the beginning of input fields. This only works for normal sized input fields and normal/small sized glyphs.</p>
        <div class="row">
        <div class="col-6">
            <div class="input-control">
                <input type="email" class="input-contains-icon" placeholder="Email"/><span class="icon"><i class="fa fa-envelope small"></i></span>
            </div>
            <div class="input-control">
                <input type="password" class="input-contains-icon" placeholder="Password"/><span class="icon"><i class="fa fa-lock small"></i></span>
            </div>
            <button class="animated btn-success pull-right">Log In</button>
        </div>
...
&lt;/div&gt;</code></pre>
        ...
        <h6>Multi-sized Glyphs</h6>
        <p>Below are some examples of how Font Awesome glyphs look with different textfield sizes. To add a glyph on the left side, add <code>input-contains-icon-left</code> to the input box inside <code>input-control</code> and a span sibling with classes <code>icon icon-left</code>. The process is the same for glyphs on the right, but the <code>left</code> is changed to <code>right</code>.</p>
        <p>Remember to add sizes to the glyph themselves which include <code>x-small</code>, <code>small</code>, <code>large</code>, <code>x-large</code>, and nothing for default.</p>
        <div class="row">
            <div class="input-control">
...
&lt;/div&gt;</code></pre>
        ...
        <space class="large"></space>
        <p>You can also create labels to go along with the textfield to give more detail to the user. There are a couple of different labels you can use in forms to help add context, namely <code>label</code> elements and the <code>info</code> class.</p>
        <div class="row">
            <div class="col-6">
                <h6>Regular Label</h6>
                <label class="font-normal">Just an ordinary label.</label>
                <input type="text" placeholder="The label above is a regular label."/>
            </div>
            <div class="col-6">
                <h6>Info Label</h6>
                <span class="info text-center">Here's some more info.</span>
                <input type="text" placeholder="The label above me displays additional info."/>
            </div>
        </div>
        <space></space>
        <h6>Some Examples</h6>
        <div class="row">
            ...
            <div class="col-6">
                <pre><code class="html" data-lang="HTML">&lt;label class=&quot;font-normal&quot;&gt;E-mail&lt;/label&gt;
&lt;input type=&quot;email&quot; placeholder=&quot;john.doe@cirrus.io&quot;/&gt;
&lt;span class=&quot;info text-center&quot;&gt;We promise we won't spam!&lt;/span&gt;</code></pre>
            </div>
        </div>

        <space class="large"></space>
        <p>If more info is needed to be displayed, you can easily add <code>&lt;span class=&quot;info&quot;&gt;More info&lt;/span&gt;</code> and <code>&lt;span class=&quot;info inline&quot;&gt;More info&lt;/span&gt;</code> (for inline displays).
        <div class="row level">
            <div class="col-6">
                <label class="font-normal">Phone Number</label><span class="info">Just for verification purposes</span>
                <input type="tel" placeholder="1-800-HOTLINEBLING"/>
                <span class="info text-center">We promise we won't spam!</span>
            </div>
            <div class="col-6">
                <label class="font-normal">City<span class="info inline">wya boi</span></label>
                <input type="text" placeholder="Send me your location."/>
                <span class="info text-center">Not used for tracking purposes*</span>
            </div>
        </div>
    </div>
</section>

    <section id="textareas" class="padtop">
        <div class="content">
            <h3>TextArea</h3>
            <div class="divider"></div>
            <p>Text areas are a great way to allow users to input more data with multiline support compared to a regular text field.</p>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <pre><code class="html" data-lang="HTML">&lt;textarea&gt;Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.&lt;/textarea&gt;
&lt;input type=&quot;submit&quot; class=&quot;btn-accent pull-right&quot;&gt;</code></pre>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <pre><code class="html" data-lang="HTML">&lt;textarea disabled&gt;Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.&lt;/textarea&gt;
&lt;input disabled type=&quot;submit&quot; class=&quot;btn-accent pull-right&quot;&gt;</code></pre>
                </div>
            </div>
        </div>
    </section>

    <section id="sampleforms" class="padtop">
        <div class="content">
            <h3>Form Sections</h3>
            <div class="divider"></div>
            <p>The <code>form-section</code> class provides a generic container for form controls such as grouping labels and inputs together. Unlike <code>form-group</code>, <code>form-section</code> does not override default styling of labels and inputs. To display labels and inputs inline, add the <code>section-inline</code> class to the <code>form-section</code> container.</p>
            <div class="row">
                <div class="col-6">
             ...
             <div class="col-6">
                    <pre><code class="html" data-lang="HTML">&lt;form method=&quot;post&quot; action=&quot;#&quot; class=&quot;form&quot; autocomplete=&quot;off&quot;&gt;
    &lt;div class=&quot;form-section&quot;&gt;
        &lt;label class=&quot;font-normal&quot;&gt;Email:&lt;span class=&quot;required&quot;&gt;*&lt;/span&gt;&lt;/label&gt;
        &lt;input type=&quot;email&quot; placeholder=&quot;This is a generic form-section.&quot;/&gt;
    &lt;/div&gt;
...
&lt;/form&gt;</code></pre>
    ...
    <section>
        <div class="content">
            <h3>Forms Groups</h3>
            <div class="divider"></div>
            <p>Cirrus allows you to bundle input fields in form groups with other components such as buttons, dropdown menus, or labels using the <code>form-group</code> class. This adds some unique styling to the elements creating a unified design when combining these components together.</p>
            <div class="row">
                <div class="col-6">
                ...
                <div class="col-6">
                    <pre><code class="html" data-lang="HTML">&lt;div class=&quot;form-group&quot;&gt;
    &lt;input type=&quot;search&quot; class=&quot;form-group-input&quot; placeholder=&quot;Search&quot;&gt;&lt;/input&gt;
    &lt;button class=&quot;form-group-btn&quot;&gt;Go&lt;/button&gt;
&lt;/div&gt;
&lt;div class=&quot;form-group&quot;&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <p>To display controls like buttons and labels on the right side, just place that component last.</p>
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
...
&lt;/div&gt;</code></pre>
            ...
            <space class="large"></space>
            <p>And of course, more controls can be combined with each other with different sizes.</p>
            <div class="row">
                <div class="form-group">
                    ...
                    <button class="form-group-btn btn-accent btn-tiny">Go</button>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <button class="form-group-btn btn-accent btn-large">Go</button>
                </div>
                <div class="form-group">
                    ...
                    <button class="form-group-btn btn-accent btn-xlarge">Go</button>
                </div>
            </div>
            <div class="row">
                <pre><code class="html" data-lang="HTML">&lt;div class=&quot;form-group&quot;&gt;
...
&lt;/div&gt;</code></pre>
            ...
            <space></space>
            <h6>Integrating Them All Together</h6>
            <p>The form below utilizes most of the different components in <code>forms.css</code>.</p>
            <div class="row no-padding">
                <div class="form-section">
                    <label class="font-bold">Contact</label>
                    <div class="section-body row no-padding">
                        <div class="col-6">
                            <div class="input-control">
                                <input class="input-contains-icon-left input-small" type="text" placeholder="Name" />
                                <span class="icon icon-left"><i class="fa fa-user small"></i></span>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="input-control">
                                ...
                                <span class="icon icon-left"><i class="fa fa-envelope small"></i></span>
                                <span class="icon icon-right"><i class="fa fa-check small"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <pre><code class="html" data-lang="HTML">&lt;div class=&quot;row no-padding&quot;&gt;
    &lt;div class=&quot;form-section&quot;&gt;
        &lt;label class=&quot;font-bold&quot;&gt;Contact&lt;/label&gt;
        &lt;div class=&quot;section-body row no-padding&quot;&gt;
            &lt;div class=&quot;col-6&quot;&gt;
        ...
        <div class="content">
            ...
            <ul class="pagination no-bullets">
                <li class="pagination-item pagination-prev">
                    <a href="../footer" class="display-block">
                        <p class="pagination-item-subtitle">Previous</p>
                        <h5 class="light no-margin">Footer</h5>
                    </a>
                </li>
                <li class="pagination-item pagination-next">
                    <a href="../header" class="display-block">
                        <p class="pagination-item-subtitle">Next</p>
                        <h5 class="light no-margin">Header</h5>
                    </a>
                </li>
            </ul>
        </div>
...
<footer>
        ...
        <div class="content">
            ...
            <div class="row">
                <div class="col-3">
                    <ul class="no-bullets">
                        <a href="#"><li class="list-item">Animations</li></a>
                        <a href="#"><li class="list-item">Buttons</li></a>
                        <a href="#"><li class="list-item">Cards</li></a>
                    <ul>
                </div>
                 <div class="col-3">
                    <ul class="no-bullets">
                        <a href="#"><li class="list-item">Font</li></a>
                        <a href="#"><li class="list-item">Footer</li></a>
                        <a href="#"><li class="list-item">Forms</li></a>
                    <ul>
                </div>
                <div class="col-3">
                    <ul class="no-bullets">
                        <a href="#"><li class="list-item">Header</li></a>
                        <a href="#"><li class="list-item">Layout</li></a>
                        <a href="#"><li class="list-item">Links</li></a>
                    <ul>
                </div>
                <div class="col-3">
                    <ul class="no-bullets">
                        <a href="#"><li class="list-item">Lists</li></a>
                        <a href="#"><li class="list-item">Table</li></a>
                        <a href="#"><li class="list-item">Util</li></a>
                    </ul>
                </div>
            </div>
        </div>
