...
<html>
  ...
  <body>
        ...
        <section id="landing" class="hero fullscreen">
            <video preload="auto" autoplay="" loop="" class="fillWidth fadeIn video-fullscreen this-overlay" poster="demo_res/img/skyhigh.jpg">
            ...
            <div class="hero-body">
                <div class="content text-center">
                    ...
                    <p id="version" class="white card text-center">0.5.2</p>
        ...
        <section id="started" class="padtop">
            <div class="content">
                ...
                <div class="row">
                    ...
                    <pre><code class="shell">$ npm install cirrus-ui --save</code></pre>
                </div>

                <div class="row">
                    <h6 class="title">Install with Yarn</h6>
                    <p>You can use Yarn to install Cirrus.</p>
                    <pre><code class="shell">$ yarn add cirrus-ui</code> </pre>
                </div>

                <div class="row">
                    <h6 class="title">CDN with unpkg</h6>
                    <pre><code>https://unpkg.com/cirrus-ui@0.5.2/dist/cirrus.min.css</code></pre>
                </div>
...
&lt;input type=&quot;submit&quot;/&gt;</code></pre>
    ...
    <section id="cards" class="padtop"><div class="content">
            <h3>Cards</h3>
            <div class="divider"></div>
            <p>An elegant way of presenting information in an intuitive user interface.</p>
            <div class="row fluid-container">
                <!-- 3 cards per row -->
                <div class="col-4">
                    <div class="card">
            ...
            <a href="docs/cards"><div class="btn-container"><button class="pull-right">See More<i class="fa fa-chevron-right pad-left"></i></button></div></a>
        </div>
    </section>
         ...
         <section id="footer" class="padtop">
            <div class="content">
                ...
                <p>Who said making footers had to be difficult? Cirrus provides a powerful set of base styles to allow you to create the footer that fits your website.</p>
                 <a href="#"><button disabled class="pull-right">Coming Soon<i class="fa fa-chevron-right pad-left"></i></button></a>
            </div>
        </section>
