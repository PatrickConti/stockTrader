...
public class PortfolioServices {
	private static final String QUOTE_SERVICE = "http://" + System.getenv("QUOTE_HOST") + ":9081/stock-quote";
	private static final String LOYALTY_SERVICE = "http://" + System.getenv("LOYALTY_HOST") + ":9082/loyalty";
	
//	private static final String DELETE_PORTFOLIO_REST_SERVICE = "https://129.40.117.225:9443/trader/deletePortfolio/";
//	private static final String CREATE_PORFOLIO_REST_SERVICE = "https://129.40.117.225:9443/trader/addPortfolio?owner=";
//	private static final String GET_PORTFOLIO_REST_SERVICE = "https://129.40.117.225:9443/trader/viewPortfolio/";
//	private static final String GET_ALL_PORTFOLIO_REST_SERVICE = "https://129.40.117.225:9443/trader/queryPortfolio";
//	private static final String ADD_STOCK_TO_PORFOLIO = "https://129.40.117.225:9443/trader/addStock";
	
	private static final String BASE_PATH = System.getenv("ZCEE_BASE_PATH");
	
	private static final String DELETE_PORTFOLIO_REST_SERVICE = System.getenv("ZCEE_URL") + BASE_PATH + "/deletePortfolio/";
	private static final String CREATE_PORFOLIO_REST_SERVICE = System.getenv("ZCEE_URL") + BASE_PATH + "/addPortfolio?owner=";
	private static final String GET_PORTFOLIO_REST_SERVICE = System.getenv("ZCEE_URL") + BASE_PATH + "/viewPortfolio/";
	private static final String GET_ALL_PORTFOLIO_REST_SERVICE = System.getenv("ZCEE_URL") + BASE_PATH + "/queryPortfolio";
	private static final String ADD_STOCK_TO_PORFOLIO = System.getenv("ZCEE_URL") + BASE_PATH + "/addStock";
...
//		System.out.println(inJson);
	...
	private static JsonStructure invokeREST(String verb, String uri) throws IOException {
		System.out.println("Invoking " + verb + " REST API to URI: " + uri);
 		URL url = new URL(uri);
		HttpURLConnection conn = (HttpURLConnection) url.openConnection();
		conn.setRequestMethod(verb);
		
//		Add basic authentication
//		if (uri != QUOTE_SERVICE && uri != LOYALTY_SERVICE) {
		if (uri.startsWith(System.getenv("ZCEE_URL"))) {
			System.out.println("Adding Basic Auth Credentials to request");
			String user = System.getenv("ZCEE_USER");
			String pass = System.getenv("ZCEE_PASS");
